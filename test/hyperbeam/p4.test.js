...
describe("Hyperbeam", function () {
  ...
  // MOVED TO fail/p4-fail.test.js: "should handle payment with lua (type conversion issue)"
  // REASON: HyperBEAM's JSON codec applies type conversion (ao-types) BEFORE signature verification
})
