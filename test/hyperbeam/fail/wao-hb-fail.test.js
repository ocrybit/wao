/**
 * Failing tests from wao-hb.test.js
 *
...
describe("wao-hb FAIL: Send().receive() pattern", function () {
  let hbeam, ao, ao2
  ...
  it("FAIL #1: should spawn a message from a handler with receive", async () => {
  ...
  it("FAIL #2: should handle replies between multiple processes", async () => {
    const src_data = `
