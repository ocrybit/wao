...
```
Read install.md and set up the full WAO development environment. Install Erlang, HyperBEAM, build hbsig, configure .env.hyperbeam, then run the HyperBEAM tests to verify everything works.
```
