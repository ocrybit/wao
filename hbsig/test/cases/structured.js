// Test cases for structured codec (TABM format)
// These test the structured_from and structured_to functions

// =============================================================================
// Test cases for structured_from (TABM to native)
// Input: TABM format with ao-types annotations
// Output: Native JavaScript values
// =============================================================================
...
// Input: Native JavaScript values
// Output: TABM format with ao-types annotations
// =============================================================================
...
// =============================================================================
// Pending cases for structured codec
// These cases have known issues with the current implementation
// =============================================================================

// Boolean type not supported in Erlang structured codec (returns as-is)
export const cases_boolean_pending = [
  // Boolean values without type annotation fail in Erlang
  {
    enabled: true,
    disabled: false,
    description: "Erlang structured codec does not support boolean type",
  },
]

export default { cases_from, cases_to }
